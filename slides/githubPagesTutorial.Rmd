...
Take out `webSite` folder and rename it to USERNAME.github.io, where USERNAME is your GitHub username.
...
In GitHub Desktop add the repo using the "+" symbol and use ""
...
You first need to create a repository with USERNAME.github.com. From GitHub Desktop, click the "+" symbol, and create a new repository. 
